...
console.log('Names of Guests Invited :',list);
...
console.log('Names of Guests Invited after Changing Guests:',list);
...
console.log('Names of Guests Invited after adding more Guests:',list);
...
console.log('Actual number of Peoples invited according to the Exercise NO 16 is:',list.length);
